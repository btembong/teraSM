    ...
    <div>
      <div className="mb-8 -mt-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 leading-none">Exam Management</h1>
            <p className="text-sm text-gray-400 mt-0.5">Schedule exams, assign invigilators, and manage exam venues</p>
          </div>
        </div>
      </div>
      {children}
