    ...
    <div>
      <div className="mb-8 -mt-1">
        <div className="flex items-center gap-1 text-xs text-gray-400 mb-4">
          ...
          <span className="text-gray-700 font-medium">Student Life</span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 leading-none">Student Life</h1>
            <p className="text-sm text-gray-400 mt-0.5">Clubs, events, hostel allocation, and maintenance requests</p>
          </div>
        </div>
      </div>
      {children}
