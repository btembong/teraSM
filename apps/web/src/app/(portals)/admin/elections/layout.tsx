    ...
    <div>
      <div className="mb-8 -mt-1">
        <div className="flex items-center gap-1 text-xs text-gray-400 mb-4">
          ...
          <span className="text-gray-700 font-medium">Elections</span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 leading-none">Elections</h1>
            <p className="text-sm text-gray-400 mt-0.5">Manage student government elections, candidates, and voting</p>
          </div>
        </div>
      </div>
      {children}
